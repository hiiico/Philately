...
public class UserControllerImpl implements UserController {
    ...
    public UserControllerImpl(LoggedUser loggedUser, UserServiceImpl userService, StampsServiceImpl stampsService) {
    ...
    public String logout() {
        ...
        this.stampsService.removeFromWishList(loggedUser.getId());
